//
//  TrendMoviesCollectionViewCell.swift
//  MovieApp
//
...
class TrendMoviesCollectionViewCell: UICollectionViewCell {
    
    static let cellIdentifier = "TrendMoviesCollectionViewCell"
...
//MARK: - Helpers
extension TrendMoviesCollectionViewCell {
    ...
    private func layout() {
        ...
        NSLayoutConstraint.activate([
            ...
            movieImageView.leadingAnchor.constraint(equalTo: contentView.leadingAnchor, constant: 2),
